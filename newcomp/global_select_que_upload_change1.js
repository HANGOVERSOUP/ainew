...
export default function Top_select({method,method2,method3,page,routed}) {
  ...
  return (
    ...
    <div>   
        ...
        {/* 만드는중 */}        
        <div id ='select_que_outline'>
            <div id='select_data_location'>
            ...
            <div id='select_que_btn_outline'>

                {/* 조건에 맞춰 버튼을 변경합시다 업로드, 모델실행 등 */}

                {page === 1 ? (
                    <Button id='select_que_btn' onClick={() => method(selectfile)} endIcon={<FileUploadIcon />} focusRipple={true} size="large"  variant="contained" color="primary">
                        데이터 업로드
